...
const SearchModal: React.FC<IProps> = () => {
  ...
  const [isCryptosLoading, setIsCryptosLoading] = useState<boolean>(false);
  ...
  const redirectToSlots = () => {
    window.location.href = '/cryptoslot/spin';
  };
    ...
    >
      ...
      <div className="w-full mt-5 flex flex-col items-center">
        <div className="w-full flex flex-wrap items-stretch">
          ...
          {!isCryptosLoading && cryptoLists?.length === 0 && (
